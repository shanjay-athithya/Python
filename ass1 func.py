...
while True:
    ...
    if option=="a":
        ...
        if string== "1":
            print(adding_indel(species1))
        elif string=="2":
            print(adding_indel(species2))
    if option=="d":
        string=input("enter the SEQUENCE needed to be changed (1 or 2) : ")
        index=int(input("enter the index number at which the indel has to be deleted : "))       
        if string=="1":
            print(deleting_indel(species1))
        elif string=="2":
            print(deleting_indel(species2))
    if option == "s":
        print(scoring(species1,species2))
    if option== "q":
        print(quit(species1,species2))